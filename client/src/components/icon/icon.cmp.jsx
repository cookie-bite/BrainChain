...
export const Icon = ({ name, size = 20, color = '--white', style }) => {
    return (
		...
		c15.1,0,27.4,12.3,27.4,27.4C338.9,270.9,334.9,274.9,329.8,274.9z" />
                    <path fill={getColor(color)} d="M425.8,134.7L279.1,51.8c-14-7.9-31.3-7.9-45.3,0l-146.7,83C72.8,142.9,64,158.1,64,174.5V339c0,16.5,8.9,31.6,23.1,39.6
		...
		c0,2.5-0.1,4.8-0.5,7.1c12.9,14.9,15,36.3,5.2,53.5c7.5,8.5,11.6,19.3,11.6,30.6C412.2,317.8,401.5,334.4,385.1,342L385.1,342z" />
                    <path fill={getColor(color)} d="M494.8,338.8V174.4c0-33-17.8-63.2-46.4-79.5l-146.7-83c-28-15.9-62.3-15.9-90.4,0L64.7,95c-28.7,16.2-46.4,46.6-46.4,79.5
		...
		C333.5,250.7,321.9,239.3,307.8,239.3z"/>
            ...
            {name === 'code-slash' && <svg xmlns="http://www.w3.org/2000/svg" className="ionicon" width={+size} heigth={+size} viewBox="0 0 512 512">
                <path fill={getColor(color)}
            ...
            {name === 'color-palette' && <svg xmlns="http://www.w3.org/2000/svg" className="ionicon" width={+size} heigth={+size} viewBox="0 0 512 512">
                <path
                    fill={getColor(color)} d="M441 336.2l-.06-.05c-9.93-9.18-22.78-11.34-32.16-12.92l-.69-.12c-9.05-1.49-10.48-2.5-14.58-6.17-2.44-2.17-5.35-5.65-5.35-9.94s2.91-7.77 5.34-9.94l30.28-26.87c25.92-22.91 40.2-53.66 40.2-86.59s-14.25-63.68-40.2-86.6c-35.89-31.59-85-49-138.37-49C223.72 48 162 71.37 116 112.11c-43.87 38.77-68 90.71-68 146.24s24.16 107.47 68 146.23c21.75 19.24 47.49 34.18 76.52 44.42a266.17 266.17 0 0086.87 15h1.81c61 0 119.09-20.57 159.39-56.4 9.7-8.56 15.15-20.83 15.34-34.56.21-14.17-5.37-27.95-14.93-36.84zM112 208a32 32 0 1132 32 32 32 0 01-32-32zm40 135a32 32 0 1132-32 32 32 0 01-32 32zm40-199a32 32 0 1132 32 32 32 0 01-32-32zm64 271a48 48 0 1148-48 48 48 0 01-48 48zm72-239a32 32 0 1132-32 32 32 0 01-32 32z"
                />
            </svg>}
            ...
            {name === 'dice' && <svg xmlns="http://www.w3.org/2000/svg" className="ionicon" viewBox="0 0 512 512">
                <path fill={getColor(color)}
            ...
            {name === 'game-controller' && <svg xmlns="http://www.w3.org/2000/svg" className="ionicon" width={+size} heigth={+size} viewBox="0 0 512 512">
                <path fill={getColor(color)}
            ...
            {name === 'hardware-chip' && <svg xmlns="http://www.w3.org/2000/svg" className="ionicon" viewBox="0 0 512 512">
                <path
                ...
                <rect fill={getColor(color)} x="160" y="160" width="192" height="192" rx="8" ry="8" />
                <path fill={getColor(color)}
            ...
            {name === 'reader-o' && <svg xmlns="http://www.w3.org/2000/svg" className="ionicon" width={+size} heigth={+size} viewBox="0 0 512 512">
                <rect x="96" y="48" width="320" height="416" rx="48" ry="48" fill="none" stroke={getColor(color)}
                    strokeLinejoin="round" strokeWidth="32" />
                <path fill="none" stroke={getColor(color)} strokeLinecap="round" strokeLinejoin="round"
                    strokeWidth="32" d="M176 128h160M176 208h160M176 288h80" />
            </svg>}
