const aiQuestions_1_1 = require('../questions/İronhack/1.1_questions.js');
const aiQuestions_1_2 = require('../questions/İronhack/1.2_questions.js');
...
exports.genQuiz = (topic, count) => {
    const quiz = {
        ai: [...aiQuestions_1_1, ...aiQuestions_1_2],
        astronomy: [
            {
                hasContent: false,
